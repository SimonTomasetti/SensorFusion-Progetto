...
// Dichiarazioni di costanti e funzioni
#define NORMAL               0
#define SUSPEND              1
#define LOW_POWER_1          2
#define STANDBY              3
#define LOW_POWER_2          4
#define DEEP_SUSPEND         5
#define FAST_POWER_UP        6
#define ADVANCED_POWERSAVE   7
#define REGULAR              8
#define ENHANCED_REGULAR     9
#define HIGH_ACCURACY       10
#define SLEEP               11
#define FORCE_MODE          12
#define LOW_POWER           13
